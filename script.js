      ...
      articles.forEach(function (element, index) {
        if (language == 'en') {
          let news = `<div class="card">
                        ...
                        <div id="collapse${index}" class="collapse" aria-labelledby="heading${index}" data-parent="#englishNewsAccordion">
          ...
          let news = `<div class="card">
                        ...
                        <div id="collapse${index}" class="collapse" aria-labelledby="heading${index}" data-parent="#germanNewsAccordion">
                            <div class="card-body"> ${element['content']}. <a href="${element['url']}" target="_blank" >Read more here</a>  </div>
                        </div>
                    </div>`;
          newsHtml += news;
